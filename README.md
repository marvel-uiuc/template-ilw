# template-ilw-typescript

Links: **[template-ilw-typescript in Builder](https://builder3.toolkit.illinois.edu/component/template-ilw-typescript/index.html)** | 
...
```html
<template-ilw-typescript></template-ilw-typescript>
```
